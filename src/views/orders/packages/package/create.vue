      ...
      <el-tabs type="border-card">
        <el-tab-pane label="Asosiy">
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item label="Qaysi manzilga" prop="from_address">
                <el-input
            ...
            <el-col :span="12" class="custom-col">
              <el-form-item label="Yetqazib berish summasi">
                <el-input v-model="packageForm.delivery_fee_amount" type="number"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-tab-pane>
          ...
          <el-row>
            ...
            <el-col :span="12" class="custom-col">
              <el-form-item label="Expired at">
                ...
                <el-time-picker
                  v-model="packageForm.time_expired_at"
                  :picker-options="{
...
export default {
  ...
  methods: {
    ...
    createPackage(){
      ...
      this.$store.dispatch('packages/createPackage', this.packageForm)
      .then(response=>{
        this.$message({
          showClose: true,
